...
const footerLinks = {
  Product: [
    ...
    { label: "Mock Tests", href: "/exams/upsc" },
    { label: "Study Materials", href: "/exams/ssc" },
  ],
  Exams: [
    { label: "UPSC", href: "/exams/upsc" },
    { label: "SSC", href: "/exams/ssc" },
    { label: "Banking", href: "/exams/banking" },
    { label: "Railways", href: "/exams/railways" },
    { label: "State PCS", href: "/exams/upsc" },
  ],
  Resources: [
    { label: "Current Affairs", href: "/exams/upsc" },
    { label: "Blog", href: "#" },
    { label: "Success Stories", href: "#testimonials" },
    { label: "Free Downloads", href: "/sign-up" },
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-4 py-12 sm:px-6 md:flex-row lg:px-8">
          <div className="text-center md:text-left">
            ...
            <p className="mt-1 text-sm text-background/70">
              Get daily current affairs and exam tips delivered to your inbox.
            </p>
          </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm text-background/70">
              ...
              Empowering aspirants since 2018.
            </p>
            <div className="mt-6">
              <p className="text-xs text-background/50">Download our app</p>
              <div className="mt-2 flex gap-2">
                <a href="#" className="rounded-lg bg-background/10 px-3 py-2 text-xs transition-colors hover:bg-background/20">
                  App Store
                </a>
                <a href="#" className="rounded-lg bg-background/10 px-3 py-2 text-xs transition-colors hover:bg-background/20">
                  Play Store
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-background/10 pt-8 md:flex-row">
          <p className="text-sm text-background/50">
            © {new Date().getFullYear()} ExamWaliSite. All rights reserved.
          </p>
